class ReceivablesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @receivable.save
        format.html { redirect_to receivable_url(@receivable), notice: "Receivable was successfully created." }
  ...
  def update
    respond_to do |format|
      if @receivable.update(user_receivable_params)
        format.html { redirect_to receivable_url(@receivable), notice: "Receivable was successfully updated." }
